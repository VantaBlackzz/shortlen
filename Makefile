...
test:
	${DOCKER_COMPOSE} exec -u www-data php bin/phpunit
cache:
...
db_schema_validate:
	${DOCKER_COMPOSE} exec -u www-data php bin/console doctrine:schema:validate

db_drop:
	docker-compose -f ./docker/docker-compose.yml exec -u www-data php bin/console doctrine:schema:drop --force
